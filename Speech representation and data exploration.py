#######################################################################################
# @Purpose:  Speech representation and data exploration 
...
sample_rate, samples = wavfile.read("D:/WPy-3662/scripts/mfcc2class/train/audio/bed/"+filename)
